...
def relative_residual(appr):
    ...
    \begin{table}[H]
        ...
        \label{table:rhos}
    \end{table}\noindent
    \Tab{rhos} reveals that they all have similar rates of convergence,
    ...
    Intuitively, we expect the algorithm to converge more slowly if the lattice
    is finer, since the have to do more work to find a finer approximation.
